...
async def startup_event():
    ...
    try:
        ...
        await db.email_signup_challenges.create_index("challenge_id", unique=True)
        await db.email_signup_challenges.create_index("email")
        await db.email_signup_challenges.create_index("expires_at", expireAfterSeconds=0)
