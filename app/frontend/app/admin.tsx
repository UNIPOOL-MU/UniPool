...
export default function AdminScreen() {
  ...
  const load = useCallback(async () => {
    ...
    if (peopleResult.status === "rejected" && statsResult.status === "rejected") Alert.alert("Admin error", "Could not load admin data. Please try again.");
    setLoading(false);
  }, []);
